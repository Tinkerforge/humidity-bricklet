...
/* ***********************************************************
 * This file was automatically generated on 2014-02-19.      *
 *                                                           *
...
function BrickDC(uid, ipcon) {
    ...
    */
    ...
    this.isEnabled = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickDC.FUNCTION_IS_ENABLED, [], '', 'B', returnCallback, errorCallback);
    };   
...
function BrickIMU(uid, ipcon) {
    ...
    */
    ...
    this.areLedsOn = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickIMU.FUNCTION_ARE_LEDS_ON, [], '', 'B', returnCallback, errorCallback);
    };   
    ...
    this.isOrientationCalculationOn = function(returnCallback, errorCallback) {
        ...
        .. versionadded:: 2.0.2~(Firmware)
        */
        this.ipcon.sendRequest(this, BrickIMU.FUNCTION_IS_ORIENTATION_CALCULATION_ON, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getProtocol1BrickletName = function(port, returnCallback, errorCallback) {
        /*
        Returns the firmware and protocol version and the name of the Bricklet for a
...
function BrickMaster(uid, ipcon) {
    ...
    */
    ...
    this.isChibiPresent = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_IS_CHIBI_PRESENT, [], '', 'B', returnCallback, errorCallback);
    };   
    ...
    this.isRS485Present = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_IS_RS485_PRESENT, [], '', 'B', returnCallback, errorCallback);
    };   
    ...
    this.isWifiPresent = function(returnCallback, errorCallback) {
        ...
        .. versionadded:: 1.2.0~(Firmware)
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_IS_WIFI_PRESENT, [], '', 'B', returnCallback, errorCallback);
    };   
    this.setWifiConfiguration = function(ssid, connection, ip, subnet_mask, gateway, port, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_SET_WIFI_CONFIGURATION, [ssid, connection, ip, subnet_mask, gateway, port], 's32 B B4 B4 B4 H', '', returnCallback, errorCallback);
    };
    ...
    this.setWifiEncryption = function(encryption, key, key_index, eap_options, ca_certificate_length, client_certificate_length, private_key_length, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 1.3.0~(Firmware)
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_SET_WIFI_ENCRYPTION, [encryption, key, key_index, eap_options, ca_certificate_length, client_certificate_length, private_key_length], 'B s50 B B H H H', '', returnCallback, errorCallback);
    };
    ...
    this.setWifiCertificate = function(index, data, data_length, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 1.3.0~(Firmware)
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_SET_WIFI_CERTIFICATE, [index, data, data_length], 'H B32 B', '', returnCallback, errorCallback);
    };
    ...
    this.isEthernetPresent = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_IS_ETHERNET_PRESENT, [], '', 'B', returnCallback, errorCallback);
    };   
    this.setEthernetConfiguration = function(connection, ip, subnet_mask, gateway, port, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.1.0~(Firmware)
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_SET_ETHERNET_CONFIGURATION, [connection, ip, subnet_mask, gateway, port], 'B B4 B4 B4 H', '', returnCallback, errorCallback);
    };
    ...
    this.setEthernetMACAddress = function(mac_address, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.1.0~(Firmware)
        */
        this.ipcon.sendRequest(this, BrickMaster.FUNCTION_SET_ETHERNET_MAC_ADDRESS, [mac_address], 'B6', '', returnCallback, errorCallback);
    };
    this.getProtocol1BrickletName = function(port, returnCallback, errorCallback) {
        /*
        Returns the firmware and protocol version and the name of the Bricklet for a
...
function BrickServo(uid, ipcon) {
    ...
    */
    ...
    this.enable = function(servo_num, returnCallback, errorCallback) {
        /*
        Enables a servo (0 to 6). If a servo is enabled, the configured position,
        velocity, acceleration, etc. are applied immediately.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_ENABLE, [servo_num], 'B', '', returnCallback, errorCallback);
    };
    this.disable = function(servo_num, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_DISABLE, [servo_num], 'B', '', returnCallback, errorCallback);
    };
    this.isEnabled = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns *true* if the specified servo is enabled, *false* otherwise.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_IS_ENABLED, [servo_num], 'B', 'B', returnCallback, errorCallback);
    };
    this.setPosition = function(servo_num, position, returnCallback, errorCallback) {
        /*
        ...
        :func:`SetDegree`.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_SET_POSITION, [servo_num, position], 'B h', '', returnCallback, errorCallback);
    };
    this.getPosition = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the position of the specified servo as set by :func:`SetPosition`.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_POSITION, [servo_num], 'B', 'h', returnCallback, errorCallback);
    };
    this.getCurrentPosition = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the *current* position of the specified servo. This may not be the
        value of :func:`SetPosition` if the servo is currently approaching a
        position goal.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_CURRENT_POSITION, [servo_num], 'B', 'h', returnCallback, errorCallback);
    };
    this.setVelocity = function(servo_num, velocity, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_SET_VELOCITY, [servo_num, velocity], 'B H', '', returnCallback, errorCallback);
    };
    this.getVelocity = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the velocity of the specified servo as set by :func:`SetVelocity`.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_VELOCITY, [servo_num], 'B', 'H', returnCallback, errorCallback);
    };
    this.getCurrentVelocity = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the *current* velocity of the specified servo. This may not be the
        value of :func:`SetVelocity` if the servo is currently approaching a
        velocity goal.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_CURRENT_VELOCITY, [servo_num], 'B', 'H', returnCallback, errorCallback);
    };
    this.setAcceleration = function(servo_num, acceleration, returnCallback, errorCallback) {
        /*
        ...
        The default value is 65535.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_SET_ACCELERATION, [servo_num, acceleration], 'B H', '', returnCallback, errorCallback);
    };
    this.getAcceleration = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the acceleration for the specified servo as set by 
        :func:`SetAcceleration`.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_ACCELERATION, [servo_num], 'B', 'H', returnCallback, errorCallback);
    };
    ...
    this.setPulseWidth = function(servo_num, min, max, returnCallback, errorCallback) {
        /*
        ...
        maximum pulse width.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_SET_PULSE_WIDTH, [servo_num, min, max], 'B H H', '', returnCallback, errorCallback);
    };
    this.getPulseWidth = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the minimum and maximum pulse width for the specified servo as set by
        :func:`SetPulseWidth`.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_PULSE_WIDTH, [servo_num], 'B', 'H H', returnCallback, errorCallback);
    };
    this.setDegree = function(servo_num, min, max, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_SET_DEGREE, [servo_num, min, max], 'B h h', '', returnCallback, errorCallback);
    };
    this.getDegree = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the minimum and maximum degree for the specified servo as set by
        :func:`SetDegree`.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_DEGREE, [servo_num], 'B', 'h h', returnCallback, errorCallback);
    };
    this.setPeriod = function(servo_num, period, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_SET_PERIOD, [servo_num, period], 'B H', '', returnCallback, errorCallback);
    };
    this.getPeriod = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the period for the specified servo as set by :func:`SetPeriod`.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_PERIOD, [servo_num], 'B', 'H', returnCallback, errorCallback);
    };
    this.getServoCurrent = function(servo_num, returnCallback, errorCallback) {
        /*
        Returns the current consumption of the specified servo in mA.
        */
        this.ipcon.sendRequest(this, BrickServo.FUNCTION_GET_SERVO_CURRENT, [servo_num], 'B', 'H', returnCallback, errorCallback);
    };
...
function BrickStepper(uid, ipcon) {
    ...
    */
    ...
    this.isEnabled = function(returnCallback, errorCallback) {
        ...
        Returns *true* if the driver chip is enabled, *false* otherwise.
        */
        this.ipcon.sendRequest(this, BrickStepper.FUNCTION_IS_ENABLED, [], '', 'B', returnCallback, errorCallback);
    };   
    ...
    this.setSyncRect = function(sync_rect, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickStepper.FUNCTION_SET_SYNC_RECT, [sync_rect], 'B', '', returnCallback, errorCallback);
    };
    this.isSyncRect = function(returnCallback, errorCallback) {
        ...
        .. versionadded:: 1.1.4~(Firmware)
        */
        this.ipcon.sendRequest(this, BrickStepper.FUNCTION_IS_SYNC_RECT, [], '', 'B', returnCallback, errorCallback);
    };   
    this.setTimeBase = function(time_base, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickStepper.FUNCTION_SET_TIME_BASE, [time_base], 'I', '', returnCallback, errorCallback);
    };
...
function BrickletBarometer(uid, ipcon) {
    ...
    */
    ...
    this.setReferenceAirPressure = function(air_pressure, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletBarometer.FUNCTION_SET_REFERENCE_AIR_PRESSURE, [air_pressure], 'i', '', returnCallback, errorCallback);
    };
    this.getChipTemperature = function(returnCallback, errorCallback) {
        /*
    ...
    this.setAveraging = function(moving_average_pressure, average_pressure, average_temperature, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletBarometer.FUNCTION_SET_AVERAGING, [moving_average_pressure, average_pressure, average_temperature], 'B B B', '', returnCallback, errorCallback);
    };
    this.getAveraging = function(returnCallback, errorCallback) {
        /*
        Returns the averaging configuration as set by :func:`SetAveraging`.
...
function BrickletCurrent12(uid, ipcon) {
    ...
    */
    ...
    this.isOverCurrent = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletCurrent12.FUNCTION_IS_OVER_CURRENT, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getAnalogValue = function(returnCallback, errorCallback) {
        /*
        Returns the value as read by a 12-bit analog-to-digital converter.
    ...
    */
    ...
    this.isOverCurrent = function(returnCallback, errorCallback) {
        ...
        .. note::
         To reset this value you have to power cycle the Bricklet.
        */
        this.ipcon.sendRequest(this, BrickletCurrent25.FUNCTION_IS_OVER_CURRENT, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getAnalogValue = function(returnCallback, errorCallback) {
        /*
        Returns the value as read by a 12-bit analog-to-digital converter.
...
function BrickletDualButton(uid, ipcon) {
    ...
    */
    ...
    this.setLEDState = function(led_l, led_r, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletDualButton.FUNCTION_SET_LED_STATE, [led_l, led_r], 'B B', '', returnCallback, errorCallback);
    };
...
function BrickletDualRelay(uid, ipcon) {
    ...
    */
    ...
    this.callbackFormats[BrickletDualRelay.CALLBACK_MONOFLOP_DONE] = 'B B';
    ...
    this.setState = function(relay1, relay2, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletDualRelay.FUNCTION_SET_STATE, [relay1, relay2], 'B B', '', returnCallback, errorCallback);
    };
    this.getState = function(returnCallback, errorCallback) {
        /*
        Returns the state of the relays, *true* means on and *false* means off.
        */
        this.ipcon.sendRequest(this, BrickletDualRelay.FUNCTION_GET_STATE, [], '', 'B B', returnCallback, errorCallback);
    };   
    this.setMonoflop = function(relay, state, time, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletDualRelay.FUNCTION_SET_MONOFLOP, [relay, state, time], 'B B I', '', returnCallback, errorCallback);
    };
    this.getMonoflop = function(relay, returnCallback, errorCallback) {
        ...
        .. versionadded:: 1.1.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletDualRelay.FUNCTION_GET_MONOFLOP, [relay], 'B', 'B I I', returnCallback, errorCallback);
    };
    this.setSelectedState = function(relay, state, returnCallback, errorCallback) {
        ...
        .. versionadded:: 2.0.0~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletDualRelay.FUNCTION_SET_SELECTED_STATE, [relay, state], 'B B', '', returnCallback, errorCallback);
    };
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletGPS(uid, ipcon) {
    ...
    */
    ...
    this.restart = function(restart_type, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletGPS.FUNCTION_RESTART, [restart_type], 'B', '', returnCallback, errorCallback);
    };
...
function BrickletHallEffect(uid, ipcon) {
    ...
    */
    ...
    this.callbackFormats[BrickletHallEffect.CALLBACK_EDGE_COUNT] = 'I B';
    ...
    this.getValue = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletHallEffect.FUNCTION_GET_VALUE, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getEdgeCount = function(reset_counter, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletHallEffect.FUNCTION_GET_EDGE_COUNT, [reset_counter], 'B', 'I', returnCallback, errorCallback);
    };
    this.setEdgeCountConfig = function(edge_type, debounce, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletHallEffect.FUNCTION_SET_EDGE_COUNT_CONFIG, [edge_type, debounce], 'B B', '', returnCallback, errorCallback);
    };
    ...
    this.edgeInterrupt = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletHallEffect.FUNCTION_EDGE_INTERRUPT, [], '', 'I B', returnCallback, errorCallback);
    };   
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletIO16(uid, ipcon) {
    ...
    */
    ...
    this.setPort = function(port, value_mask, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletIO16.FUNCTION_SET_PORT, [port, value_mask], 'c B', '', returnCallback, errorCallback);
    };
    ...
    this.setPortConfiguration = function(port, selection_mask, direction, value, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletIO16.FUNCTION_SET_PORT_CONFIGURATION, [port, selection_mask, direction, value], 'c B c B', '', returnCallback, errorCallback);
    };
    ...
    this.setPortInterrupt = function(port, interrupt_mask, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletIO16.FUNCTION_SET_PORT_INTERRUPT, [port, interrupt_mask], 'c B', '', returnCallback, errorCallback);
    };
    ...
    this.setPortMonoflop = function(port, selection_mask, value_mask, time, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletIO16.FUNCTION_SET_PORT_MONOFLOP, [port, selection_mask, value_mask, time], 'c B B I', '', returnCallback, errorCallback);
    };
    ...
    this.setSelectedValues = function(port, selection_mask, value_mask, returnCallback, errorCallback) {
        /*
        Sets the output value (high or low) for a port ("a" or "b" with a bitmask, 
        ...
        .. versionadded:: 2.0.0~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIO16.FUNCTION_SET_SELECTED_VALUES, [port, selection_mask, value_mask], 'c B B', '', returnCallback, errorCallback);
    };
    this.getEdgeCount = function(pin, reset_counter, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.3~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIO16.FUNCTION_GET_EDGE_COUNT, [pin, reset_counter], 'B B', 'I', returnCallback, errorCallback);
    };
    this.setEdgeCountConfig = function(pin, edge_type, debounce, returnCallback, errorCallback) {
        /*
        ...
        * 2 = both
        ...
        .. versionadded:: 2.0.3~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIO16.FUNCTION_SET_EDGE_COUNT_CONFIG, [pin, edge_type, debounce], 'B B B', '', returnCallback, errorCallback);
    };
...
function BrickletIO4(uid, ipcon) {
    ...
    */
    ...
    this.setValue = function(value_mask, returnCallback, errorCallback) {
        /*
        ...
        .. note::
         ...
         Pull-up resistors can be switched on with :func:`SetConfiguration`.
        */
        this.ipcon.sendRequest(this, BrickletIO4.FUNCTION_SET_VALUE, [value_mask], 'B', '', returnCallback, errorCallback);
    };
    this.getValue = function(returnCallback, errorCallback) {
        /*
    ...
    this.setConfiguration = function(selection_mask, direction, value, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletIO4.FUNCTION_SET_CONFIGURATION, [selection_mask, direction, value], 'B c B', '', returnCallback, errorCallback);
    };
    ...
    this.setInterrupt = function(interrupt_mask, returnCallback, errorCallback) {
        /*
        Sets the pins on which an interrupt is activated with a bitmask.
        Interrupts are triggered on changes of the voltage level of the pin,
        i.e. changes from high to low and low to high.
        ...
        The interrupt is delivered with the callback :func:`Interrupt`.
        */
        this.ipcon.sendRequest(this, BrickletIO4.FUNCTION_SET_INTERRUPT, [interrupt_mask], 'B', '', returnCallback, errorCallback);
    };
    ...
    this.setMonoflop = function(selection_mask, value_mask, time, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 1.1.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIO4.FUNCTION_SET_MONOFLOP, [selection_mask, value_mask, time], 'B B I', '', returnCallback, errorCallback);
    };
    ...
    this.setSelectedValues = function(selection_mask, value_mask, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.0~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIO4.FUNCTION_SET_SELECTED_VALUES, [selection_mask, value_mask], 'B B', '', returnCallback, errorCallback);
    };
    this.getEdgeCount = function(pin, reset_counter, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIO4.FUNCTION_GET_EDGE_COUNT, [pin, reset_counter], 'B B', 'I', returnCallback, errorCallback);
    };
    this.setEdgeCountConfig = function(selection_mask, edge_type, debounce, returnCallback, errorCallback) {
        /*
        ...
        * 2 = both
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIO4.FUNCTION_SET_EDGE_COUNT_CONFIG, [selection_mask, edge_type, debounce], 'B B B', '', returnCallback, errorCallback);
    };
    this.getEdgeCountConfig = function(pin, returnCallback, errorCallback) {
        /*
...
function BrickletIndustrialDigitalIn4(uid, ipcon) {
    ...
    */
    ...
    this.setInterrupt = function(interrupt_mask, returnCallback, errorCallback) {
        ...
        The interrupt is delivered with the callback :func:`Interrupt`.
        */
        this.ipcon.sendRequest(this, BrickletIndustrialDigitalIn4.FUNCTION_SET_INTERRUPT, [interrupt_mask], 'H', '', returnCallback, errorCallback);
    };
    this.getInterrupt = function(returnCallback, errorCallback) {
        /*
        Returns the interrupt bitmask as set by :func:`SetInterrupt`.
    ...
    this.getEdgeCount = function(pin, reset_counter, returnCallback, errorCallback) {
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIndustrialDigitalIn4.FUNCTION_GET_EDGE_COUNT, [pin, reset_counter], 'B B', 'I', returnCallback, errorCallback);
    };
    this.setEdgeCountConfig = function(selection_mask, edge_type, debounce, returnCallback, errorCallback) {
        /*
        ...
        * 2 = both
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIndustrialDigitalIn4.FUNCTION_SET_EDGE_COUNT_CONFIG, [selection_mask, edge_type, debounce], 'H B B', '', returnCallback, errorCallback);
    };
    this.getEdgeCountConfig = function(pin, returnCallback, errorCallback) {
        /*
        Returns the edge type and debounce time for the selected pin as set by
...
function BrickletIndustrialDigitalOut4(uid, ipcon) {
    ...
    */
    ...
    this.setValue = function(value_mask, returnCallback, errorCallback) {
        ...
        pins 8-11 and element 4 pins 12-15.
        */
        this.ipcon.sendRequest(this, BrickletIndustrialDigitalOut4.FUNCTION_SET_VALUE, [value_mask], 'H', '', returnCallback, errorCallback);
    };
    this.getValue = function(returnCallback, errorCallback) {
        /*
    ...
    this.setMonoflop = function(selection_mask, value_mask, time, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletIndustrialDigitalOut4.FUNCTION_SET_MONOFLOP, [selection_mask, value_mask, time], 'H H I', '', returnCallback, errorCallback);
    };
    this.getMonoflop = function(pin, returnCallback, errorCallback) {
        /*
        Returns (for the given pin) the current value and the time as set by
    ...
    this.setSelectedValues = function(selection_mask, value_mask, returnCallback, errorCallback) {
        ...
        .. versionadded:: 2.0.0~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIndustrialDigitalOut4.FUNCTION_SET_SELECTED_VALUES, [selection_mask, value_mask], 'H H', '', returnCallback, errorCallback);
    };
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletIndustrialQuadRelay(uid, ipcon) {
    ...
    */
    ...
    this.setValue = function(value_mask, returnCallback, errorCallback) {
        ...
        pins 8-11 and element 4 pins 12-15.
        */
        this.ipcon.sendRequest(this, BrickletIndustrialQuadRelay.FUNCTION_SET_VALUE, [value_mask], 'H', '', returnCallback, errorCallback);
    };
    this.getValue = function(returnCallback, errorCallback) {
        /*
        Returns the bitmask as set by :func:`SetValue`.
    ...
    this.setMonoflop = function(selection_mask, value_mask, time, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletIndustrialQuadRelay.FUNCTION_SET_MONOFLOP, [selection_mask, value_mask, time], 'H H I', '', returnCallback, errorCallback);
    };
    this.getMonoflop = function(pin, returnCallback, errorCallback) {
        /*
        Returns (for the given pin) the current value and the time as set by
    ...
    this.setSelectedValues = function(selection_mask, value_mask, returnCallback, errorCallback) {
        ...
        *false* refers to an open relay.
        ...
        .. versionadded:: 2.0.0~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletIndustrialQuadRelay.FUNCTION_SET_SELECTED_VALUES, [selection_mask, value_mask], 'H H', '', returnCallback, errorCallback);
    };
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletJoystick(uid, ipcon) {
    ...
    */
    ...
    this.isPressed = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletJoystick.FUNCTION_IS_PRESSED, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getAnalogValue = function(returnCallback, errorCallback) {
        /*
    ...
    this.setPositionCallbackThreshold = function(option, min_x, max_x, min_y, max_y, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletJoystick.FUNCTION_SET_POSITION_CALLBACK_THRESHOLD, [option, min_x, max_x, min_y, max_y], 'c h h h h', '', returnCallback, errorCallback);
    };
    ...
    this.setAnalogValueCallbackThreshold = function(option, min_x, max_x, min_y, max_y, returnCallback, errorCallback) {
        /*
        Sets the thresholds for the :func:`AnalogValueReached` callback. 
        ...
        The default value is ('x', 0, 0, 0, 0).
        */
        this.ipcon.sendRequest(this, BrickletJoystick.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD, [option, min_x, max_x, min_y, max_y], 'c H H H H', '', returnCallback, errorCallback);
    };
    this.getAnalogValueCallbackThreshold = function(returnCallback, errorCallback) {
        /*
        Returns the threshold as set by :func:`SetAnalogValueCallbackThreshold`.
...
function BrickletLCD16x2(uid, ipcon) {
    ...
    */
    ...
    this.isBacklightOn = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletLCD16x2.FUNCTION_IS_BACKLIGHT_ON, [], '', 'B', returnCallback, errorCallback);
    };   
    this.setConfig = function(cursor, blinking, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletLCD16x2.FUNCTION_SET_CONFIG, [cursor, blinking], 'B B', '', returnCallback, errorCallback);
    };
    this.getConfig = function(returnCallback, errorCallback) {
        /*
        Returns the configuration as set by :func:`SetConfig`.
        */
        this.ipcon.sendRequest(this, BrickletLCD16x2.FUNCTION_GET_CONFIG, [], '', 'B B', returnCallback, errorCallback);
    };   
    this.isButtonPressed = function(button, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletLCD16x2.FUNCTION_IS_BUTTON_PRESSED, [button], 'B', 'B', returnCallback, errorCallback);
    };
...
function BrickletLCD20x4(uid, ipcon) {
    ...
    */
    ...
    this.isBacklightOn = function(returnCallback, errorCallback) {
        ...
        Returns *true* if the backlight is on and *false* otherwise.
        */
        this.ipcon.sendRequest(this, BrickletLCD20x4.FUNCTION_IS_BACKLIGHT_ON, [], '', 'B', returnCallback, errorCallback);
    };   
    this.setConfig = function(cursor, blinking, returnCallback, errorCallback) {
        /*
        Configures if the cursor (shown as "_") should be visible and if it
        ...
        The default is (*false*, *false*).
        */
        this.ipcon.sendRequest(this, BrickletLCD20x4.FUNCTION_SET_CONFIG, [cursor, blinking], 'B B', '', returnCallback, errorCallback);
    };
    this.getConfig = function(returnCallback, errorCallback) {
        /*
        Returns the configuration as set by :func:`SetConfig`.
        */
        this.ipcon.sendRequest(this, BrickletLCD20x4.FUNCTION_GET_CONFIG, [], '', 'B B', returnCallback, errorCallback);
    };   
    this.isButtonPressed = function(button, returnCallback, errorCallback) {
        /*
        ...
        :func:`ButtonPressed` and :func:`ButtonReleased` callbacks.
        */
        this.ipcon.sendRequest(this, BrickletLCD20x4.FUNCTION_IS_BUTTON_PRESSED, [button], 'B', 'B', returnCallback, errorCallback);
    };
    this.setCustomCharacter = function(index, character, returnCallback, errorCallback) {
        /*
...
function BrickletMultiTouch(uid, ipcon) {
    ...
    */
    ...
    this.setElectrodeConfig = function(enabled_electrodes, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletMultiTouch.FUNCTION_SET_ELECTRODE_CONFIG, [enabled_electrodes], 'H', '', returnCallback, errorCallback);
    };
...
function BrickletPTC(uid, ipcon) {
    ...
    */
    ...
    this.isSensorConnected = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletPTC.FUNCTION_IS_SENSOR_CONNECTED, [], '', 'B', returnCallback, errorCallback);
    };   
...
function BrickletPiezoSpeaker(uid, ipcon) {
    ...
    */
    ...
    this.calibrate = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletPiezoSpeaker.FUNCTION_CALIBRATE, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletRemoteSwitch(uid, ipcon) {
    ...
    */
    ...
    this.switchSocket = function(house_code, receiver_code, switch_to, returnCallback, errorCallback) {
        /*
        This function is deprecated, use :func:`SwitchSocketA` instead.
        */
        this.ipcon.sendRequest(this, BrickletRemoteSwitch.FUNCTION_SWITCH_SOCKET, [house_code, receiver_code, switch_to], 'B B B', '', returnCallback, errorCallback);
    };
    ...
    this.switchSocketA = function(house_code, receiver_code, switch_to, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletRemoteSwitch.FUNCTION_SWITCH_SOCKET_A, [house_code, receiver_code, switch_to], 'B B B', '', returnCallback, errorCallback);
    };
    this.switchSocketB = function(address, unit, switch_to, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletRemoteSwitch.FUNCTION_SWITCH_SOCKET_B, [address, unit, switch_to], 'I B B', '', returnCallback, errorCallback);
    };
    this.dimSocketB = function(address, unit, dim_value, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletRemoteSwitch.FUNCTION_DIM_SOCKET_B, [address, unit, dim_value], 'I B B', '', returnCallback, errorCallback);
    };
    this.switchSocketC = function(system_code, device_code, switch_to, returnCallback, errorCallback) {
        /*
        ...
        .. versionadded:: 2.0.1~(Plugin)
        */
        this.ipcon.sendRequest(this, BrickletRemoteSwitch.FUNCTION_SWITCH_SOCKET_C, [system_code, device_code, switch_to], 'c B B', '', returnCallback, errorCallback);
    };
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletRotaryEncoder(uid, ipcon) {
    ...
    */
    ...
    this.getCount = function(reset, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletRotaryEncoder.FUNCTION_GET_COUNT, [reset], 'B', 'i', returnCallback, errorCallback);
    };
    ...
    this.isPressed = function(returnCallback, errorCallback) {
        ...
        to handle the button.
        */
        this.ipcon.sendRequest(this, BrickletRotaryEncoder.FUNCTION_IS_PRESSED, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletSegmentDisplay4x7(uid, ipcon) {
    ...
    */
    ...
    this.setSegments = function(segments, brightness, colon, returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletSegmentDisplay4x7.FUNCTION_SET_SEGMENTS, [segments, brightness, colon], 'B4 B B', '', returnCallback, errorCallback);
    };
    this.getSegments = function(returnCallback, errorCallback) {
        ...
        :func:`SetSegments`.
        */
        this.ipcon.sendRequest(this, BrickletSegmentDisplay4x7.FUNCTION_GET_SEGMENTS, [], '', 'B4 B B', returnCallback, errorCallback);
    };   
    this.startCounter = function(value_from, value_to, increment, length, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletSegmentDisplay4x7.FUNCTION_START_COUNTER, [value_from, value_to, increment, length], 'h h h I', '', returnCallback, errorCallback);
    };
...
function BrickletTilt(uid, ipcon) {
    ...
    */
    ...
    this.isTiltStateCallbackEnabled = function(returnCallback, errorCallback) {
        ...
        */
        this.ipcon.sendRequest(this, BrickletTilt.FUNCTION_IS_TILT_STATE_CALLBACK_ENABLED, [], '', 'B', returnCallback, errorCallback);
    };   
    this.getIdentity = function(returnCallback, errorCallback) {
        /*
        Returns the UID, the UID where the Bricklet is connected to, 
...
function BrickletVoltageCurrent(uid, ipcon) {
    ...
    */
    ...
    this.setConfiguration = function(averaging, voltage_conversion_time, current_conversion_time, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletVoltageCurrent.FUNCTION_SET_CONFIGURATION, [averaging, voltage_conversion_time, current_conversion_time], 'B B B', '', returnCallback, errorCallback);
    };
    this.getConfiguration = function(returnCallback, errorCallback) {
        /*
    ...
    this.setCalibration = function(gain_multiplier, gain_divisor, returnCallback, errorCallback) {
        /*
        ...
        */
        this.ipcon.sendRequest(this, BrickletVoltageCurrent.FUNCTION_SET_CALIBRATION, [gain_multiplier, gain_divisor], 'H H', '', returnCallback, errorCallback);
    };
...
},{}]},{},[26,34,10,20,28,37,8,49,40,3,38,30,6,44,9,25,43,14,1,18,29,22,39,23,51,17,21,41,45,33,42,19,48,15,46,7,4,13,2,11,36,12,5,24,27,32,16,50,31,47,35])