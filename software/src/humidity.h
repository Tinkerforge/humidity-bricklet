...
#define FID_SET_HUMIDITY_CALLBACK_PERIOD 3
#define FID_GET_HUMIDITY_CALLBACK_PERIOD 4
#define FID_SET_ANALOG_VALUE_CALLBACK_PERIOD 5
#define FID_GET_ANALOG_VALUE_CALLBACK_PERIOD 6
#define FID_SET_HUMIDITY_CALLBACK_THRESHOLD 7
#define FID_GET_HUMIDITY_CALLBACK_THRESHOLD 8
...
#define FID_HUMIDITY 13
#define FID_ANALOG_VALUE 14
#define FID_HUMIDITY_REACHED 15
